...
export function ErrorToast() {
  ...
  return (
    <div className="pointer-events-auto fixed bottom-14 left-1/2 z-[1300] flex w-[min(90vw,26rem)] -translate-x-1/2 items-start gap-3 rounded-xl border border-red-500/30 bg-neutral-900 p-4 shadow-2xl shadow-black/50">
